...
<body class="bg-light-base dark:bg-dark-base text-slate-900 dark:text-slate-100 min-h-dvh">
    ...
    <div class="flex h-dvh overflow-hidden">
        ...
        {{-- ── Sidebar ───────────────────────────────────────────────── --}}
        <aside x-data="adminSidebar()" :class="open ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
            ...
            <div class="h-16 flex items-center px-6 border-b border-dark-border shrink-0">
                <a href="{{ route('home') }}" class="font-heading text-2xl font-black gradient-text">{{ $siteInitials }}</a>
